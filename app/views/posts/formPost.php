...
<div class="container text-center my-3 p-5  border-0 shadow rounded ">
    <form action="<?php echo URLROOT; ?><?php echo $data['actionForm'];?>" method="POST" enctype="multipart/form-data" class="mx-5 mb-5" >
        <div class="mb-2">
            ...
            <input type="text" name="title" class="form-control" id="title" placeholder="Title" value="<?php echo $data['title']; ?>">
            <span class="invalidFeedback"><?php echo $data['titleError']; ?> </span>
        </div>
        
        <div class="mb-2">
            <label for="image" class="form-label fw-bold">Image Post</label>
            <input type="file" name="image" class="form-control" id="image" placeholder="image" value="<?php echo $data['image']; ?>">
        ...
        <div class="mb-5">
            ...
            <textarea class="form-control" name="body" id="body" placeholder="Text ..." rows="10"><?php echo $data['body']; ?></textarea>
