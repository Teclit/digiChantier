...
?>
    ...
    <section class="container text-center my-3 p-1  ">
        ...
        <form action="<?php echo URLROOT; ?>/leads/create" method="POST" enctype="multipart/form-data" class="mx-5 mb-5" >
            ...
            <div class="mb-3">
                <input type="tel"  name="tel" class="form-control" id="tel" placeholder="Votre Télephone">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                <select class="form-select  me-4" id="typetravaux" name="typetravaux">
            ...
            <div class="mb-3">
                <select class="form-select  me-4" id="natureravaux" name="natureravaux">
