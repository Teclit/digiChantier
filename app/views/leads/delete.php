...
?>
    ...
    <section class="container text-center my-3 p-1  ">
        ...
        <form action="<?php echo URLROOT; ?>/leads/delete/<?php echo $data['lead']->idlead ?>" method="POST" enctype="multipart/form-data" class="mx-5 mb-5" >
            ...
            <button type="submit" class="btn btn-danger btn-block px-5 ">Supprimer Lead</button>
