...
?>
    ...
    <section class="container text-center my-5 p-1  ">
            ...
            <h3 class="text-center my-5">Votre commande:</h3>
            <table class="table  table-responsive table-hover table-bordered">
                    ...
                    <tbody>
                    <?php foreach($data['commandes'] as $index=>$commande): ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <?php  }?>
                            <a href="<?php echo URLROOT."/personnels/deleteCommande/".$commande->idcmd; ?>" class="btn btn-danger btn-sm ">Supprimer</a>
                        </td>
                    </tr>
                    <?php endforeach; ?>
