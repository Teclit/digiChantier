    ...
    public function createPro() {
        ...
        if($_SERVER['REQUEST_METHOD'] == 'POST'){
            ...
            if (empty($data['nomEnt']) || !preg_match($nameValidation, $data['nomEnt'])) { 
                $data['nomEntError']   = 'Veuillez saisir votre nom';
            ...
            } elseif (empty($data['domainesEnt']) || !preg_match($nameValidation, $data['domainesEnt'])){ 
